...
import icons from './filled-symbols.mjs'

const iconList = [...new Set(icons)].sort().map(encodeURIComponent).join(',')

const url = `https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded:opsz,wght,FILL,GRAD@20,400,1,0&icon_names=${iconList}&display=block`
...
const outputPath = path.join(
  import.meta.dirname,
  'MaterialSymbolsRoundedSlice.woff2'
)
...
console.log('Done. Hard reload your browser to see the changes.')
