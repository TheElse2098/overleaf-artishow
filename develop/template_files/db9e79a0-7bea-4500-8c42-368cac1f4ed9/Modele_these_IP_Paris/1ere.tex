...
\newcommand{\ecodoctitle}{Dénomination} 													%% Nom de l'ED. () / Full name of Doctoral School. See IP Paris website
\newcommand{\ecodocacro}{Sigle}																%% Sigle de l'ED. () / Acronym of the Doctoral School. See IP Paris website
...
\newcommand{\PhDworkingplace}{Nom de l'établissement} 										%% Établissement de préparation / PhD working place :  l'Ecole polytechnique, l'Ecole nationale supérieure de techniques avancées, l'Ecole nationale de la statistique et de l’administration économique, Télécom ParisTech, Télécom SudParis   
...
\newcommand{\logoEtt}{etab2}  																%% Logo de l'établissement de soutenance. Le nom du fichier correspond au sigle de l'établissement /  Institution logo. Filename correspond to institution acronym : ENSAE, ENSTA, TPT, TSP, X 
